...
class BaseService(Generic[ModelType, CreateSchemaType, UpdateSchemaType, RepositoryType], ABC):
    ...
    async def create(self, obj_data: CreateSchemaType) -> ModelType:
        ...
        ------
        ValueError
            If custom business validation (in `_validate_create`) fails.
        IntegrityError
            If a database constraint is violated (e.g., duplicate name).
        """
    ...
    async def update(self, obj_id: int, obj_data: UpdateSchemaType) -> ModelType | None:
        ...
        ------
        ValueError
            If custom validation (in `_validate_update`) fails.
        IntegrityError
    ...
    async def _after_create(self, created_obj: ModelType, repository: RepositoryType) -> None:
        """Override to add post-creation logic (e.g., caching, notifications)."""
        pass
    ...
    async def _validate_delete(self, obj_id: int, existing_obj: ModelType, repository: RepositoryType) -> None:
        """Override to add custom validation before deletion (e.g., check dependencies)."""
        pass

    async def _after_delete(self, obj_id: int, deleted_obj: ModelType, repository: RepositoryType) -> None:
        """Override to add post-deletion logic (e.g., cleanup external resources)."""
        pass